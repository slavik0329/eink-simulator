 ...
 */
export function createDrawingContext(canvas) {
 ...
 * Draw a single pixel.
 */
export function drawPixel(dc, x, y, color) {
 ...
 */
export function drawLine(dc, x0, y0, x1, y1, color) {
 ...
 */
export function drawHLine(dc, x, y, w, color) {
    dc.ctx.fillStyle = color;
 ...
 */
export function drawVLine(dc, x, y, h, color) {
    dc.ctx.fillStyle = color;
 ...
 */
export function drawRect(dc, x, y, w, h, color) {
    dc.ctx.strokeStyle = color;
    dc.ctx.lineWidth = 1;
 ...
 * Fill a rectangle.
 */
export function fillRect(dc, x, y, w, h, color) {
    dc.ctx.fillStyle = color;
 ...
 */
export function drawCircle(dc, x, y, r, color) {
    dc.ctx.strokeStyle = color;
    dc.ctx.lineWidth = 1;
    dc.ctx.beginPath();
 ...
 * Fill a circle.
 */
export function fillCircle(dc, x, y, r, color) {
    dc.ctx.fillStyle = color;
    dc.ctx.beginPath();
    dc.ctx.arc(x, y, r, 0, Math.PI * 2);
    dc.ctx.fill();
 ...
 */
export function drawTriangle(dc, x0, y0, x1, y1, x2, y2, color) {
    dc.ctx.strokeStyle = color;
    dc.ctx.lineWidth = 1;
    dc.ctx.beginPath();
    dc.ctx.moveTo(x0 + 0.5, y0 + 0.5);
 ...
 * Fill a triangle.
 */
export function fillTriangle(dc, x0, y0, x1, y1, x2, y2, color) {
    dc.ctx.fillStyle = color;
    dc.ctx.beginPath();
    dc.ctx.moveTo(x0, y0);
    dc.ctx.lineTo(x1, y1);
 ...
 */
export function drawRoundRect(dc, x, y, w, h, r, color) {
    dc.ctx.strokeStyle = color;
    dc.ctx.lineWidth = 1;
    dc.ctx.beginPath();
    dc.ctx.moveTo(x + r, y);
 ...
 */
export function fillRoundRect(dc, x, y, w, h, r, color) {
    dc.ctx.fillStyle = color;
    dc.ctx.beginPath();
    dc.ctx.moveTo(x + r, y);
    dc.ctx.lineTo(x + w - r, y);
 ...
 */
export function drawXBitmap(dc, x, y, bitmap, w, h, color) {
 ...
 */
export function drawXBitmapScaled(dc, x, y, bitmap, srcW, srcH, destW, destH, color) {
 ...
 */
export function clearDisplay(dc, color) {
