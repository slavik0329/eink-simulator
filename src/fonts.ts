 ...
 */
export function getTextWidth(text: string, font: GFXFont): number {
  let width = 0;
  for (const char of text) {
 ...
 */
export function getTextBounds(text: string, font: GFXFont): TextBounds {
  let width = 0;
  let minY = 0;
  let maxY = 0;
  let first = true;
 ...
 */
export function getGlyph(font: GFXFont, charCode: number): GFXGlyph | undefined {
 ...
 */
export function hasChar(font: GFXFont, charCode: number): boolean {
 ...
 */
export function drawBuiltinChar(
  dc: DrawingContext,
  x: number,
  y: number,
  char: string,
 ...
 */
export function drawBuiltinText(
  dc: DrawingContext,
  text: string,
  x: number,
  y: number,
 ...
 */
export function getBuiltinTextWidth(text: string): number {
